  ...
  <body>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="nav-item dropdown sobre active">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="active"><a class="nav-link" href="correccion.php">CORRECCIÓN DE DATOS</a></li>
                </ul>
            </li>
    ...
    <div class="padre">
        ...
        <div class="padre2 div-relative" style="padding: 0px; background-color: #00539F;">
            ...
            <h3 class="futura-titulo" style="color: white; margin-top: 3px; margin-bottom: 6px; margin-left: 150px; margin-right: 3px;">Corrección de datos</h3>
        </div>
          <br>
          <div class="padre">
              <div class="hijo" style="padding: 15px;">
                <div class="div-relative">
                    <div class="row">
                        <div class="col-md-7" style="padding-left: 40px; padding-right: 40px; min-width: 850px;">
                                    <div class="justificado futura-descripcion">
                                      <p class="futura-descripcion">
                                          <div>Para solicitar corrección de datos favor de dirigir un escrito en formato</div><div>libre a las oficinas de esta entidad ubicadas en:</div><div>Country Club No. 98&nbsp;</div><div>Col. Versalles</div><div>Tepic, Nayarit</div>                                      </p>
                                    </div>
                        </div>
