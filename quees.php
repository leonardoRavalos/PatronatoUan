          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="nav-item dropdown sobre active">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li class="active"><a class="nav-link" href="quees.php">¿QUÉ ES?</a></li>
                        ...
                        <div class="col-sm-6">
                          <div class="padre" style="padding: 8px;">
                              <div class="hijo div-relative">
                                                                        <img src="uploads/images/10.jpg" class="img-fluid img-new" style="padding: 0; right: 0; bottom: 0;">
                                      
                                  <!--div class="padre" style="position: absolute;
                              ...
                              <h3 class="futura-titulo">
                                <div class="div-relative" style="text-align: left;">
                                  ...
                                  <span class="negritas"> <span style="color: #00539F;">Es</span> un ente público y descentralizado</span> <span style="color: #00539F;">que actúa con autonomía técnica y</span> de gestión para el ejercicio de su función.
                                                                ...
                                                                <p style="text-align: justify;"><span style="font-size: 12pt;">El Patronato para Administrar el Impuesto Especial Destinado a la Universidad Aut&oacute;noma de Nayarit, es una entidad p&uacute;blica descentralizada del Gobierno del Estado de Nayarit. Cuenta con autonom&iacute;a t&eacute;cnica y de gesti&oacute;n para el ejercicio de su funci&oacute;n, que consiste en concentrar y administrar el recurso proveniente del Impuesto Especial.</span></p>
<p style="text-align: justify;"><span style="font-size: 12pt;">Este recurso es una fuente alterna de financiamiento que se obtiene del 15% del pago de impuestos, derechos y productos establecidos a nivel municipal y estatal, y son sujetos de este impuesto las personas f&iacute;sicas o morales.</span></p>
<p style="text-align: justify;"><span style="font-size: 12pt;">La aplicaci&oacute;n del Impuesto Especial se ejerce para solventar las necesidades m&aacute;s apremiantes de una instituci&oacute;n educativa que busca mantener su liderazgo en cobertura y calidad en la impartici&oacute;n de educaci&oacute;n en los niveles Media Superior y Superior.</span></p>                                                        </div>
                    </div>
                </div>
              </div>
            </div>
