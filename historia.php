        ...
        <div class="div-relative" style="max-width: 1300px;">
            ...
            <div class="padre2 div-relative" style="padding: 0px; background-color: #00539F;">
                ...
                <h3 class="futura-titulo"
                    style="color: white; margin-top: 3px; margin-bottom: 6px; margin-left: 150px; margin-right: 3px;">Historia</h3>
            </div>
            <br>
            <div class="padre">
                <div class="hijo" style="max-width: 1100px;">
                    <div class="justificado">
                        <h3 class="futura-titulo">
                            <div class="div-relative" style="text-align: left;">
                                ...
                                <span class="negritas">
                      <span style="color: #00539F;">Los</span>
                  </span>
                                orígines de este Patronato parten desde el <span style="color: #00539F;">26</span> de
                                <span style="color: #00539F;">Diciembre</span> de <span
                                        style="color: #00539F;">1970</span> en
                                donde el <span style="color: #00539F;">Gobernador Constitucional</span> del Estado Libre
                                y Soberano de <span style="color: #00539F;">Nayarit.</span>
                            </div>
                        </h3>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<br>';
                    $imagenURL = 'admin/carpeta_destino/' . $row["archivo"];
                    echo '<img src="' . $imagenURL . '" class="img-fluid img-new" style="padding: 0; right: 0; bottom: 0;" height="342" width="496">';
                    echo '<br>';
                    echo '<br>';
                }
