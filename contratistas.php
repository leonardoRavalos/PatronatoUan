  ...
  <header>
    ...
    <div class="padre">
        ...
        <div class="padre2 div-relative" style="padding: 0px; background-color: #00539F;">
            ...
            <h3 class="futura-titulo" style="color: white; margin-top: 3px; margin-bottom: 6px; margin-left: 150px; margin-right: 3px;">Padrón de contratistas</h3>
        </div>
          <br>
          <div class="padre">
              <div class="hijo" style="padding: 15px;">
                                ...
                                <div class="justificado">
                                        <h3 class="futura-titulo">
                                          <div class="div-relative" style="text-align: left;">
                                            ...
                                            <span class="negritas">
                                                Formatos de inscripción al padrón de contratistas
                                            </span>
                                          </div>
                                        </h3>
                                    </div>
