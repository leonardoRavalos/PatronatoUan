  ...
  <header>
    ...
    <div class="padre">
        ...
        <div class="padre2 div-relative" style="padding: 0px; background-color: #00539F;">
            ...
            <h3 class="futura-titulo" style="color: white; margin-top: 3px; margin-bottom: 6px; margin-left: 150px; margin-right: 3px;">Organigrama</h3>

            
        </div>
          <br>
          <br>
          <!-- Insertar la imagen centrada con un tamaño de 250px -->
          <div style="text-align: center;">
          <?php
            // Conectar a la base de datos usando tu archivo de configuración
            require_once('admin/db_config.php');

            $sql = "SELECT organigrama FROM patronato";
            $result = $conn->query($sql);

            // Recorrer los resultados y generar las tarjetas de noticias
            while ($row = $result->fetch_assoc()) {
                $organigrama = $row['organigrama'];
                echo '<img src="' . $organigrama . '" alt="Organigrama" width="1150px">';
            }
