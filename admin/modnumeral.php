		...
		<tr>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td width="51%" colspan="2">&nbsp;<input type="text" size="10" name="numerop" id="numerop" autocomplete="off" autofocus  value="I.">
				    </td>
				</tr>
				<tr>
					<td width="20%" align="right"><font face="Arial">&nbsp; Titulo:</font></td>
					<td width="51%">&nbsp;<input type="text" name="titulo" id="titulo" size="50" autocomplete="off" value="Marco Normativo"></td>
					<td width="28%"><font face="Arial">&nbsp;</font></td>
				</tr>
				<tr>
          <td width="20%" align="right"><font face="Arial">&nbsp; Seccion:</font></td>
          <td width="51%" colspan="2">&nbsp;<select size="1" name="seccion">
				...
				<tr>
					...
					<input type="hidden" name="movi" value="modnumeral">
