...
<div class="container">
    ...
    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
        <ul id="myTab" class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" class="active"><a href="quehace.php">¿Qué hace?</a></li>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["contenido"])) {
        ...
        $query = "UPDATE patronato SET quien = '$nuevoContenido' "; // Ajusta el ID o condición según tus necesidades
    ...
    if (isset($_FILES["imagen"]["name"])) {
        ...
        if (move_uploaded_file($rutaTemporal, $carpetaDestino . $nombreArchivo)) {
            ...
            $query = "UPDATE patronato SET foto_quien = '$nuevaRutaImagen' "; // Ajusta el ID o condición según tus necesidades
...
$query = "SELECT quien, foto_quien FROM patronato "; // Ajusta el ID o condición según tus necesidades
