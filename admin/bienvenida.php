<!DOCTYPE html>
 ...
 <div class="menu_bar">
        ...
        <div align="center">
           <br>
            <form action="modmensa.php?id=1" method="post" name="form1" id="form1" enctype="multipart/form-data">
                <table border="2" width="50%" bordercolor="#000000" cellspacing="0" cellpadding="0" bgcolor="#1C75BC">
                    <tr>
                        <td>
