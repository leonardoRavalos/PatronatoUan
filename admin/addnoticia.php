		...
		<tr>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
					...
					<tr>
						<td width="20%" align="right"><font face="Arial">&nbsp; Nota corta:</font></td>
						<td colspan="2">
							&nbsp; <textarea rows="5" cols="56" id="nota" name="nota" class="areax"></textarea>
						</td>
					</tr>

					<tr>
						<td width="20%" align="right"><font face="Arial">&nbsp; Texto:</font></td>
						<td colspan="2">
...
if (isset($_POST['guardar'])) {
    ...
    if ($_FILES['imagen']['name']) {
        ...
        if (in_array($imagen_extension, $extensiones_validas)) {
            ...
            $imagen_ruta = $imagen_nombre; // Ruta completa de la imagen
            ...
            if (move_uploaded_file($imagen_temp, $carpeta_destino . $imagen_nombre)) {
                ...
                $sql = "INSERT INTO noticias (imagen, titulo, nota, NOTA_LARGA) VALUES (?, ?, ?, ?)";
                if ($stmt = $conn->prepare($sql)) {
                    $stmt->bind_param("ssss", $imagen_ruta, $_POST['titulo'], $_POST['nota'], $_POST['descri']);
                    if ($stmt->execute()) {
