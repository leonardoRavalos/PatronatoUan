...
if (isset($_GET['id'])) {
    ...
    $sqlFormato = "SELECT archivo  FROM doctos_numeral WHERE numerales = $idformato";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['guardar'])) {
    ...
    $sql = "UPDATE doctos_numeral SET archivo = '$targetFile'  WHERE numerales = $idformato";
    
    if ($conn->query($sql) === TRUE) {
        // Formato actualizado con éxito
        // Puedes redirigir o mostrar un mensaje de éxito
        header("Location: numerales.php"); // Reemplaza 'tu_pagina.php' con la página a la que deseas redirigir
        exit();
    } else {
